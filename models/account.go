...
type Account struct {
	...
	TransfersFrom []Transfer `gorm:"foreignKey:FromAccountID;references:ID" json:"-"`
	TransfersTo   []Transfer `gorm:"foreignKey:ToAccountID;references:ID" json:"-"`
	Entries       []Entry    `gorm:"foreignKey:AccountID;references:ID" json:"-"`
}
